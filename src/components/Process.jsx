      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start w-full gap-20 md:gap-4">
          {steps.map((step, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center flex-1 relative w-full"
            >
              {/* Title */}
                  ...
                  <div className="absolute left-[50%] w-full h-[1px] bg-zinc-800/80">
                    ...
                    >
                      <div className="relative flex items-center justify-center">
                        {/* The Arrow Head */}
                        <svg
                          className="w-6 h-6 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
