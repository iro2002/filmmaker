...
const Showreels = () => {
  ...
  return (
    <div className="w-full h-screen bg-black relative flex items-center justify-center overflow-hidden z-50">
      ...
      {/* Showreel Credits */}
      <div className="absolute bottom-6 md:bottom-10 w-full text-center text-white/60 text-[10px] md:text-xs tracking-[0.3em] uppercase font-light z-20 pointer-events-none">
