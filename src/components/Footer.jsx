...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative w-full bg-[#020202] text-white pt-48 md:pt-64 pb-6 overflow-hidden flex flex-col items-center">
      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <h2 className="text-4xl md:text-6xl font-serif tracking-tight leading-tight mb-6">
            Ready to frame <br />
            <span className="italic text-zinc-500 font-light">the extraordinary?</span>
          </h2>
          <a 
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
          ...
          */}
          <motion.a 
            href="#contact" 
            animate={{ boxShadow: ["0px 0px 0px 0px rgba(255,255,255,0.2)", "0px 0px 0px 15px rgba(255,255,255,0)"] }}
            transition={{ repeat: Infinity, duration: 2 }}
            className="relative flex items-center justify-center w-32 h-32 md:w-40 md:h-40 rounded-full border border-white hover:bg-white hover:text-black transition-colors duration-500 group"
          >
            <span className="absolute font-serif text-lg tracking-widest uppercase">Start</span>
          ...
          <div className="flex gap-12 text-sm tracking-widest uppercase text-zinc-400">
            ...
            <div className="flex flex-col gap-4 items-center md:items-start">
              <a href="#vimeo" className="hover:text-white transition-colors duration-300">Vimeo</a>
              <a href="#ig" className="hover:text-white transition-colors duration-300">Instagram</a>
              <a href="#x" className="hover:text-white transition-colors duration-300">X (Twitter)</a>
            </div>
          </div>
        </div>
